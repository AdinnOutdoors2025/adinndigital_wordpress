...
<body>
    ...
    <!-- <div style=" margin:auto; font-family:'Montserrat', Arial, sans-serif;"> -->
  ...
  font-size:35px;
  color:#FFFFFF;">
            <div>Hi <?php echo $userName; ?>, Welcome to Adinn Outdoors!</div>
        </div>
        <!-- <h1 style="color: #333;">Hi ${userName}, Welcome to Adinn Outdoors!</h1> -->
        <p style="font-size: 17px;color:black;">You have successfully registered with us. We're glad to have you on
            board! </p>
        <h2 style="color: #333; margin-top: 20px;"> Your Registration Details</h2>
        <ul style="font-size: 17px;">
            <li><strong>Name: </strong> <?php echo $userName; ?></li>
            <li><strong>Email: </strong> <?php echo $userEmail; ?></li>
            <li><strong>Phone: </strong> <a href='tel:<?php echo $userPhone; ?>'> <?php echo $userPhone; ?> </a></li>
        </ul>
            ...
            <tr>
                <td align="center">
                    ...
                    <table align="center" width="65%" cellpadding="0" cellspacing="0" style="margin-left: 20%;">
                        <tr>
                            <td align="center" style="font-size:24px; font-weight:500; color:#2B3333; ">
                                ...
                                <span style="color:#E31F25;font-weight:700;">Thank you</span> for choosing us -
                                we're
                    ...
                    <div style="color:black; font-size:14px; margin-top:30px;">
                        Copyright © 2026 Adinn Outdoors. All Rights Reserved.
                    </div>
                </td>
            </tr>
        </table>
