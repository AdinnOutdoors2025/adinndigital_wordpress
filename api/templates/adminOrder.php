...
<body style="margin:0; padding:0; font-family: Arial, sans-serif;">
  ...
  font-size:35px;
  color:#FFFFFF;">
            New Order Placed by <?= $clientName ?> – Order ID #<?= $orderId ?>
        </div>
            ...
            <table border="1" cellpadding="0" cellspacing="0"
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding:12px;"> <a href="mailto:<?= $clientEmail; ?>" style="color:#2B3333; text-decoration:none;"><?= $clientEmail; ?></a></td>
                        <td style="padding:12px;"><a href='tel:<?= $clientPhone ?>'
                                style="text-decoration:none; color:black;"> +91 <?= $clientPhone ?> </a></td>
                        <td style="padding:12px;"><?= $clientCompany ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div style="font-size:20px; margin:30px 0;">
            ...
            If any corrections or updates are needed, please reach out to the customer using the provided contact
            details.
        </div>
